...
class SmokeTab(BaseModelTab):
    """Tab for testing the smoke / fire detection model."""

    RESULT_COLUMNS = ("y_true_raw", "y_true_win", "y_pred", "y_proba")

    def _build_config_group(self) -> QGroupBox:
        group = QGroupBox("Configuration — Smoke / Fire")
        ...
        model_row, self._model_edit, _ = self._make_file_row(
            "Model (.pkl):", DEFAULT_SMOKE_MODEL, "Select model", "Model files (*.pkl)"
        )
